...
symbols = [
    ...
    Symbol("(", ["paren", "open paren", "left paren"], None),
    Symbol(")", ["R paren", "right paren"], None),
    Symbol("[", None,["brack", "open brack", "bracket", "open bracket", "left bracket", "square", "open square", "left square",],),
    Symbol("]", None, ["R brack", "R bracket", "right bracket", "R square", "right square"]),
    Symbol("/", ["forward slash"], ["slash"]),
    Symbol("\\", None, ["backslash"]),
    Symbol("{", None, ["brace", "open brace", "left brace", "curly bracket", "left curly bracket"],),
    Symbol("}", None, ["R brace", "right brace","R curly bracket", "right curly bracket"]),
    Symbol("<", None, ["angle", "open Angle", "left angle", "less than"]),
